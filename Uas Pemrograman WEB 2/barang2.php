...
<body>
  ...
  <div class="content container mt-3">
    ...
    <!-- CRUD Table -->
    <center><button class="btn btn-success"><i class="fas fa-plus"></i><a  href="tambah_barang.php" style="color:#fff">Tambah</a></button>  
      <a href="cetak3.php" target="_blank" class="btn btn-primary btn-cetak"><i class="fas fa-print"></i> Cetak</a>
      <a href="unduh3.php" class="btn btn-warning btn-unduh"><i class="fas fa-download"></i> Unduh</a>
    </center>
    <br/>
    <table class="table">
      <thead>
  ...
  if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    $data = mysqli_query($koneksi,"select * from barang where namabarang like '%".$cari."%'");       
  }else{
  ...
  ?>
       <tr>
          ...
          <td>
            <button class="btn btn-info"><i class="fas fa-edit"></i><a href="edit_barang.php?id=<?php echo $d['id']; ?>"style="color:#fff"> Edit </a></button>
            <button class="btn btn-danger"><i class="fas fa-trash"></i><a href="proses_hapusbarang.php?id=<?php echo $d['id']; ?>"style="color:#fff"> Hapus </a></button>
          </td>
      </tr>   
      <?php } ?>
    </tbody>
